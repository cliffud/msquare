...
class ShoppingCartItemsControllerTest < ActionController::TestCase
  ...
  test "should create shopping_cart_item" do
    assert_difference('ShoppingCartItem.count') do
      post :create, shopping_cart_item: { prod_id: @shopping_cart_item.prod_id, quantity: @shopping_cart_item.quantity, user_id: @shopping_cart_item.user_id }
    end
  ...
  test "should update shopping_cart_item" do
    patch :update, id: @shopping_cart_item, shopping_cart_item: { prod_id: @shopping_cart_item.prod_id, quantity: @shopping_cart_item.quantity, user_id: @shopping_cart_item.user_id }
    assert_redirected_to shopping_cart_item_path(assigns(:shopping_cart_item))
  end
